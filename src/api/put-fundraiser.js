async function putFundraiser(fundraiserId, title, image, description, suburb, postcode, goal, deadline, is_open) {
  ...
  const response = await fetch(url, {
      ...
      if (!response.ok) {
        const fallbackError = `Error trying to edit fundraiser`;
