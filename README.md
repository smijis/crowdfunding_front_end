...
- A screenshot of the fundraiser creation page  
  ![Create Fundraiser Screenshot](./src/assets/createfundraiser-screenshot.png)

- A screenshot of a fundraiser with pledges  
  ![Fundraiser with Pledges Screenshot](./src/assets/fundraiserwithpledges-screenshot.png)
